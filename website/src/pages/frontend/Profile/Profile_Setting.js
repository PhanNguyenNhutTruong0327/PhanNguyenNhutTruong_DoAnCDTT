                                ...
                                <div className="card-body">
                                    <form className="row">
                                            ...
                                            <div className="form-row row">
                                                <div className="col-md-6">
                                                    <div className="col form-group mb-2">
                                                        ...
                                                        <input type="text" className="form-control" value="Ahihi" />
                                                    </div> 
                                                    <div className="col form-group mb-2">
                                                        <label class="mb-1">Email :</label>
                                                        <input type="email" className="form-control" value="ahihi@gmail.com" />
                                                    </div>
                                                    <div className="form-group col-md-6 mb-2">
                                                        ...
                                                        <select id="inputState" className="form-control" style={{width:"380px"}}>
                                                            ...
                                                            <option selected="0">Tiền Giang</option>
                                        ...
                                        <div className="col-md-2">
                                            <img src={require("../../../assets/images/avata/avt-1.jpg")} width="100px" height="100px" className="img-md rounded-circle border" />
                                        </div>  {/*-- col.// -*/}
                                    </form>
                                </div> {/*-- card-body.// -*/}
                            </div> {/*-- card .// -*/}
