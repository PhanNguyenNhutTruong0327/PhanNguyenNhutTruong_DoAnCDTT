...
function My_Profile() {
    ...
    useEffect(()=>{
        (async ()=>{
            await userservices.getUserInfo(token).then((res)=>{
                                ...
                                <article class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <figure class="icontext">
                                            <div class="d-flex">
                                                <div class="icon-avt " >
                                                    <img class="rounded-circle img-sm border" src={urlImage + "User/" + user.image} style={{height:"150px",width:"150px"}}  />
                                                </div>
                                                <div class="text ms-3">
                                        ...
                                        <p class="text-address">
                                            ...
                                            <i class="ms-5" style={{fontSize:"17px"}}>{user.address}</i>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <figure class="itemside  mb-3">
                                                    <div class="aside d-flex flex-row"><img src={require("../../../assets/images/products/banh-bong-lan-cha-bong.jpg")} style={{height:"100px",width:"100px"}} class="border img-sm" /></div>
                                            ...
                                            <div class="col-md-6">
                                                <figure class="itemside  mb-3">
                                                    <div class="aside"><img src={require("../../../assets/images/products/banh-donut.jpg")} class="border img-sm" style={{height:"100px",width:"100px"}} /></div>
                                                    <figcaption class="info">
                                                        <time class="text-muted" style={{ fontSize: "15px" }}><i class="fa fa-calendar-alt"></i> 12.09.2019</time>
                                            ...
                                            <div class="col-md-6">
                                                <figure class="itemside mb-3">
                                                    <div class="aside"><img src={require("../../../assets/images/products/banh-my-croissant-socola.jpg")} style={{height:"100px",width:"100px"}} class="border img-sm" /></div>
                                                    <figcaption class="info">
                                                        <time class="text-muted" style={{ fontSize: "15px" }}><i class="fa fa-calendar-alt"></i> 12.09.2019</time>
        ...
        return(
            <div style={{height:"300px"}}>
                <div class="text-center" style={{paddingTop:"5%"}}>
                    <h6>Bạn chưa đăng nhập vào hệ thống ?</h6>
