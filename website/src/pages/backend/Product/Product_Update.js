...
function Product_Update() {
    ...
    useEffect(() => {
        (async ()=>{
            await productServices.getById(id).then((res) => {
                ...
                setBrandId(res.data.product.brand_id);
                setCatID(res.data.product.category_id);
    ...
    async function productUpdate(event) {
        ...
        await productServices.update(id,product).then(function (res) {
    ...
    return (
        <form action="" method="post" onSubmit={productUpdate}>
