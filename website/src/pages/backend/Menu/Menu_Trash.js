...
function Menu_Trash() {
    ...
    useEffect(() => {
        (async () => {
            await menuservices.getTrash().then((res) => {
    ...
    function RescoverTrash(id) {
        menuservices.RescoverTrash(id).then(function (result) {
                            ...
                            <table class="table table-bordered" id="mytable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{ width: "300px" }}>Tên menu</th>
                                        <th>Link</th>
                                        <th>Vị trí</th>
                                        <th></th>
                                    </tr>
                                            ...
                                            <tr class="datarow" key={index}>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="function_style d-flex">
                                                        <Link to={`/admin/menu/show/${pro.id}`} style={{ fontSize: "14px" }}><i class="fa fa-eye me-1"></i>Chi tiết</Link>
                                                    </div>
                                                </td>
                                                <td>{pro.link}</td>
                                                <td>{pro.position}</td>
