...
function User_Trash() {
    ...
    useEffect(()=>{
        (async ()=>{
            await userservices.getTrash('admin').then((res)=>{
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3  ">
                                        <div className="text-right ms-5">
                                            <Link to="/admin/user" class="btn btn-sm btn-info me-3 ">
                                            ...
                                            <tr class="datarow" key={index} >
                                                ...
                                                <td>
                                                    ...
                                                    <div class="function_style d-flex">
                                                        <Link to={`/admin/user/show/${tra.id}`} style={{fontSize:"14px"}}><i className="fa fa-eye"></i> Chi tiết</Link>
                                                    </div>
                                                </td>
                                                <td>{tra.email}</td>
                                                <td>{tra.phone}</td>
