...
function Trash_Category() {
    ...
    useEffect(()=>{
        (async ()=>{
            await categoryservice.getTrash().then((res)=>{
    ...
    function RescoverTrash(id) {
        categoryservice.RescoverTrash(id).then(function (result) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3  ">
                                        <div className="text-right ms-5">
                                            <Link to="/admin/category" class="btn btn-sm btn-info me-3 ">
                ...
                <section class="content">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h6>Hiện không có danh mục nào !</h6>
                        </div>
                    </div>
                </section>
            </div>
                                    ...
                                    {trash.map((tra, index) => {
                                        return (
                                            <tr class="datarow" key={index} >
                                                ...
                                                <td>
                                                    <img src={urlImage + 'Category/' + tra.image} style={{ width: "100%" }} />
                                                </td>
                                                <td>
                                                    <div class="name">
                                                        {tra.name}
                                                    ...
                                                    <div class="function_style d-flex" style={{fontSize:"14px"}}>
                                                        <Link to={`/admin/category/show/${tra.id}`}><i className="fa fa-eye me-1"></i>Chi tiết</Link>
                                                    </div>
                                                </td>
