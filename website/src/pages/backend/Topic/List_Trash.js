...
function List_Trash() {
    ...
    useEffect(()=>{
        (async ()=>{
            await topicservice.getTrash().then((res)=>{
    ...
    function RescoverTrash(id) {
        topicservice.RescoverTrash(id).then(function (result) {
    ...
    function deleted(id) {
        topicservice.deleteTopic(id).then(function (result) {
            alert(result.data.message);
            setCountTrash(id);
        })
    }
                                            ...
                                            <tr class="datarow" key={index} >
                                                ...
                                                <td>
                                                    ...
                                                    <div class="function_style d-flex">
                                                        <a href="#">Hiện</a> |
                                                        <Link to={`/admin/topic/update/${tra.id}`}>Chỉnh sửa</Link> |
                                                        <Link to={`/admin/topic/show/`}>Chi tiết</Link> |
                                                        <button>Xoá</button>
                                                    </div>
                                                </td>
                                                <td>{tra.slug}</td>
