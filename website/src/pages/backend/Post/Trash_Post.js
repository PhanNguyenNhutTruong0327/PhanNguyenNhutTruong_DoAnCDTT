...
function Trash_Post() {
    ...
    useEffect(()=>{
        (async ()=>{
            await postservices.getTrash('post').then((res)=>{
    ...
    function RescoverTrash(id) {
        postservices.RescoverTrash(id).then(function (result) {
    ...
    function deleted(id) {
        postservices.remove(id).then(function (result) {
            alert(result.data.message);
            setTamp(id);
        })
    }
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3  ">
                                        <div className="text-right ms-5">
                                            <Link to="/admin/post" class="btn btn-sm btn-info me-3 ">
                                            ...
                                            <tr class="datarow" key={index} >
                                                ...
                                                <td>
                                                    ...
                                                    <div class="function_style d-flex">
                                                        <Link to={`/admin/post/show/${tra.id}`} style={{fontSize:"14px"}}><i className="fa fa-eye"></i> Chi tiết</Link>
                                                    </div>
                                                </td>
                                                <td>{tra.topicname}</td>
                                                <td>{tra.detail}</td>
