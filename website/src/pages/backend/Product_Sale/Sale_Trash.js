...
function Sale_Trash() {
    ...
    useEffect(() => {
        (async () => {
            await productServices.getTrashSale().then((res) => {
    ...
    function RescoverTrash(id) {
        productServices.RescoverTrashSale(id).then(function (result) {
    ...
    function deleted(id) {
        productServices.deletedProductSale(id).then(function (result) {
            alert(result.data.message);
            setTamp(id);
        })
    }
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 text-right ">
                                        <div className="text-right ms-5">
                                            <Link to="/admin/product/sale" class="btn btn-sm btn-info me-3 ">
                                            ...
                                            <tr class="datarow" key={index}>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="function_style d-flex">
                                                        <Link to={`/admin/product/sale/show/${pro.idsale}`} style={{ fontSize: "14px" }}><i class="fa fa-eye me-1"></i>Chi tiết</Link>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="text-center">
                                                    <button onClick={() => RescoverTrash(pro.idsale)} className="btn btn-outline-success me-2">
                                                        <i class="fa fa-history" aria-hidden="true"></i>
                                                    </button>
                                                    <button onClick={() => deleted(pro.idsale)} className="btn btn-outline-danger">
